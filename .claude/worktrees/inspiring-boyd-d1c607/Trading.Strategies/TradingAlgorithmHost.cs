...
using Trading.Strategies.Auditing;
...
namespace Trading.Strategies
{
    ...
    {
        private const bool EnableSignalAuditing = true; // false para apagar
        ...
        private SignalAuditor _signalAuditor;
        ...
        public override void Initialize()
        {
            ...
            if (EnableSignalAuditing)
            {
                var recomputers = new List<IIndicatorRecomputer>
                {
                    new EmaCrossIndicatorRecomputer()
                    // futuras estrategias: registrar su recomputer aquí
                };
                _signalAuditor = new SignalAuditor(recomputers, _logger);
            }
