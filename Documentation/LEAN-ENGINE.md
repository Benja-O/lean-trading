...
> Este documento es el `readme.md` original del motor **QuantConnect/Lean** sobre el que está construido este proyecto. Se preservó aquí, sin modificar, como referencia técnica del engine base. El README de la raíz del repositorio describe el sistema de trading propio construido encima.
