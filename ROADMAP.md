...
**Estado:** implementado 2026-06-19 (`ITradeFeed` + `BinanceAggTradeRestFeed`, REST default; 4 tests + smoke test real OK). **Pendiente:** re-deploy del recorder al VPS con `RECORDER_FEED=rest` y validar barras cerrándose en el store.
